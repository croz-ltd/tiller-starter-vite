    ...
    return (
        <div className="flex flex-col items-center justify-center mx-auto my-auto max-w-xl h-screen">
            ...
            <div className="flex my-8">
                ...
                <p className="text-2xl font-bold">Welcome to Tiller Vite App!</p>
            </div>
            <p className="text-lg text-center leading-9">A handy production-ready template
                for <strong>rapid</strong> frontend development that you've often dreamed of. Included awesome Vite
